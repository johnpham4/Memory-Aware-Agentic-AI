-- Initialize PostgreSQL database with pgvector and memory tables
...
CREATE INDEX IF NOT EXISTS idx_tool_log_memory_executed_at
    ON tool_log_memory(executed_at);
